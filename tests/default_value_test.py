...
def test_returns_first_member_for_str_enum() -> None:
    assert default_value(Color) == Color.RED


def test_returns_first_member_for_int_enum() -> None:
    assert default_value(Priority) == Priority.LOW
